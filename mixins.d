...
// expansion at ../../.dub/packages/bindbc-sdl/1.2.4/bindbc-sdl/source/bindbc/sdl/bind/sdlvideo.d(319,5)
alias SDL_GL_CONTEXT_RELEASE_BEHAVIOR_NONE = SDL_GLcontextReleaseFlag.SDL_GL_CONTEXT_RELEASE_BEHAVIOR_NONE;alias SDL_GL_CONTEXT_RELEASE_BEHAVIOR_FLUSH = SDL_GLcontextReleaseFlag.SDL_GL_CONTEXT_RELEASE_BEHAVIOR_FLUSH;

// expansion at ../../.dub/packages/bindbc-sdl/1.2.4/bindbc-sdl/source/bindbc/sdl/bind/sdlvideo.d(333,5)
alias SDL_HITTEST_NORMAL = SDL_HitTestResult.SDL_HITTEST_NORMAL;alias SDL_HITTEST_DRAGGABLE = SDL_HitTestResult.SDL_HITTEST_DRAGGABLE;alias SDL_HITTEST_RESIZE_TOPLEFT = SDL_HitTestResult.SDL_HITTEST_RESIZE_TOPLEFT;alias SDL_HITTEST_RESIZE_TOP = SDL_HitTestResult.SDL_HITTEST_RESIZE_TOP;alias SDL_HITTEST_RESIZE_TOPRIGHT = SDL_HitTestResult.SDL_HITTEST_RESIZE_TOPRIGHT;alias SDL_HITTEST_RESIZE_RIGHT = SDL_HitTestResult.SDL_HITTEST_RESIZE_RIGHT;alias SDL_HITTEST_RESIZE_BOTTOMRIGHT = SDL_HitTestResult.SDL_HITTEST_RESIZE_BOTTOMRIGHT;alias SDL_HITTEST_RESIZE_BOTTOM = SDL_HitTestResult.SDL_HITTEST_RESIZE_BOTTOM;alias SDL_HITTEST_RESIZE_BOTTOMLEFT = SDL_HitTestResult.SDL_HITTEST_RESIZE_BOTTOMLEFT;alias SDL_HITTEST_RESIZE_LEFT = SDL_HitTestResult.SDL_HITTEST_RESIZE_LEFT;

// expansion at ../../.dub/packages/bindbc-sdl/1.2.4/bindbc-sdl/source/bindbc/sdl/bind/sdlvideo.d(344,5)
alias SDL_GL_CONTEXT_RESET_NO_NOTIFICATION = SDL_GLContextResetNotification.SDL_GL_CONTEXT_RESET_NO_NOTIFICATION;alias SDL_GL_CONTEXT_RESET_LOSE_CONTEXT = SDL_GLContextResetNotification.SDL_GL_CONTEXT_RESET_LOSE_CONTEXT;

// expansion at ../../.dub/packages/bindbc-sdl/1.2.4/bindbc-sdl/source/bindbc/sdl/bind/sdlsyswm.d(113,1)
alias SDL_SYSWM_UNKNOWN = SDL_SYSWM_TYPE.SDL_SYSWM_UNKNOWN;alias SDL_SYSWM_WINDOWS = SDL_SYSWM_TYPE.SDL_SYSWM_WINDOWS;alias SDL_SYSWM_X11 = SDL_SYSWM_TYPE.SDL_SYSWM_X11;alias SDL_SYSWM_DIRECTFB = SDL_SYSWM_TYPE.SDL_SYSWM_DIRECTFB;alias SDL_SYSWM_COCOA = SDL_SYSWM_TYPE.SDL_SYSWM_COCOA;alias SDL_SYSWM_UIKIT = SDL_SYSWM_TYPE.SDL_SYSWM_UIKIT;alias SDL_SYSWM_WAYLAND = SDL_SYSWM_TYPE.SDL_SYSWM_WAYLAND;alias SDL_SYSWM_MIR = SDL_SYSWM_TYPE.SDL_SYSWM_MIR;alias SDL_SYSWM_WINRT = SDL_SYSWM_TYPE.SDL_SYSWM_WINRT;alias SDL_SYSWM_ANDROID = SDL_SYSWM_TYPE.SDL_SYSWM_ANDROID;alias SDL_SYSWM_VIVANTE = SDL_SYSWM_TYPE.SDL_SYSWM_VIVANTE;alias SDL_SYSWM_OS2 = SDL_SYSWM_TYPE.SDL_SYSWM_OS2;alias SDL_SYSWM_HAIKU = SDL_SYSWM_TYPE.SDL_SYSWM_HAIKU;

// expansion at ../../.dub/packages/bindbc-sdl/1.2.4/bindbc-sdl/source/bindbc/sdl/bind/sdlevents.d(395,1)
alias SDL_FIRSTEVENT = SDL_EventType.SDL_FIRSTEVENT;alias SDL_QUIT = SDL_EventType.SDL_QUIT;alias SDL_APP_TERMINATING = SDL_EventType.SDL_APP_TERMINATING;alias SDL_APP_LOWMEMORY = SDL_EventType.SDL_APP_LOWMEMORY;alias SDL_APP_WILLENTERBACKGROUND = SDL_EventType.SDL_APP_WILLENTERBACKGROUND;alias SDL_APP_DIDENTERBACKGROUND = SDL_EventType.SDL_APP_DIDENTERBACKGROUND;alias SDL_APP_WILLENTERFOREGROUND = SDL_EventType.SDL_APP_WILLENTERFOREGROUND;alias SDL_APP_DIDENTERFOREGROUND = SDL_EventType.SDL_APP_DIDENTERFOREGROUND;alias SDL_LOCALECHANGED = SDL_EventType.SDL_LOCALECHANGED;alias SDL_DISPLAYEVENT = SDL_EventType.SDL_DISPLAYEVENT;alias SDL_WINDOWEVENT = SDL_EventType.SDL_WINDOWEVENT;alias SDL_SYSWMEVENT = SDL_EventType.SDL_SYSWMEVENT;alias SDL_KEYDOWN = SDL_EventType.SDL_KEYDOWN;alias SDL_KEYUP = SDL_EventType.SDL_KEYUP;alias SDL_TEXTEDITING = SDL_EventType.SDL_TEXTEDITING;alias SDL_TEXTINPUT = SDL_EventType.SDL_TEXTINPUT;alias SDL_KEYMAPCHANGED = SDL_EventType.SDL_KEYMAPCHANGED;alias SDL_TEXTEDITING_EXT = SDL_EventType.SDL_TEXTEDITING_EXT;alias SDL_MOUSEMOTION = SDL_EventType.SDL_MOUSEMOTION;alias SDL_MOUSEBUTTONDOWN = SDL_EventType.SDL_MOUSEBUTTONDOWN;alias SDL_MOUSEBUTTONUP = SDL_EventType.SDL_MOUSEBUTTONUP;alias SDL_MOUSEWHEEL = SDL_EventType.SDL_MOUSEWHEEL;alias SDL_JOYAXISMOTION = SDL_EventType.SDL_JOYAXISMOTION;alias SDL_JOYBALLMOTION = SDL_EventType.SDL_JOYBALLMOTION;alias SDL_JOYHATMOTION = SDL_EventType.SDL_JOYHATMOTION;alias SDL_JOYBUTTONDOWN = SDL_EventType.SDL_JOYBUTTONDOWN;alias SDL_JOYBUTTONUP = SDL_EventType.SDL_JOYBUTTONUP;alias SDL_JOYDEVICEADDED = SDL_EventType.SDL_JOYDEVICEADDED;alias SDL_JOYDEVICEREMOVED = SDL_EventType.SDL_JOYDEVICEREMOVED;alias SDL_CONTROLLERAXISMOTION = SDL_EventType.SDL_CONTROLLERAXISMOTION;alias SDL_CONTROLLERBUTTONDOWN = SDL_EventType.SDL_CONTROLLERBUTTONDOWN;alias SDL_CONTROLLERBUTTONUP = SDL_EventType.SDL_CONTROLLERBUTTONUP;alias SDL_CONTROLLERDEVICEADDED = SDL_EventType.SDL_CONTROLLERDEVICEADDED;alias SDL_CONTROLLERDEVICEREMOVED = SDL_EventType.SDL_CONTROLLERDEVICEREMOVED;alias SDL_CONTROLLERDEVICEREMAPPED = SDL_EventType.SDL_CONTROLLERDEVICEREMAPPED;alias SDL_CONTROLLERTOUCHPADDOWN = SDL_EventType.SDL_CONTROLLERTOUCHPADDOWN;alias SDL_CONTROLLERTOUCHPADMOTION = SDL_EventType.SDL_CONTROLLERTOUCHPADMOTION;alias SDL_CONTROLLERTOUCHPADUP = SDL_EventType.SDL_CONTROLLERTOUCHPADUP;alias SDL_CONTROLLERSENSORUPDATE = SDL_EventType.SDL_CONTROLLERSENSORUPDATE;alias SDL_FINGERDOWN = SDL_EventType.SDL_FINGERDOWN;alias SDL_FINGERUP = SDL_EventType.SDL_FINGERUP;alias SDL_FINGERMOTION = SDL_EventType.SDL_FINGERMOTION;alias SDL_DOLLARGESTURE = SDL_EventType.SDL_DOLLARGESTURE;alias SDL_DOLLARRECORD = SDL_EventType.SDL_DOLLARRECORD;alias SDL_MULTIGESTURE = SDL_EventType.SDL_MULTIGESTURE;alias SDL_CLIPBOARDUPDATE = SDL_EventType.SDL_CLIPBOARDUPDATE;alias SDL_DROPFILE = SDL_EventType.SDL_DROPFILE;alias SDL_DROPTEXT = SDL_EventType.SDL_DROPTEXT;alias SDL_DROPBEGIN = SDL_EventType.SDL_DROPBEGIN;alias SDL_DROPCOMPLETE = SDL_EventType.SDL_DROPCOMPLETE;alias SDL_AUDIODEVICEADDED = SDL_EventType.SDL_AUDIODEVICEADDED;alias SDL_AUDIODEVICEREMOVED = SDL_EventType.SDL_AUDIODEVICEREMOVED;alias SDL_SENSORUPDATE = SDL_EventType.SDL_SENSORUPDATE;alias SDL_RENDER_TARGETS_RESET = SDL_EventType.SDL_RENDER_TARGETS_RESET;alias SDL_RENDER_DEVICE_RESET = SDL_EventType.SDL_RENDER_DEVICE_RESET;alias SDL_USEREVENT = SDL_EventType.SDL_USEREVENT;alias SDL_LASTEVENT = SDL_EventType.SDL_LASTEVENT;
...
// expansion at ../../.dub/packages/bindbc-sdl/1.2.4/bindbc-sdl/source/bindbc/sdl/bind/sdlsensor.d(21,5)
alias SDL_SENSOR_INVALID = SDL_SensorType.SDL_SENSOR_INVALID;alias SDL_SENSOR_UNKNOWN = SDL_SensorType.SDL_SENSOR_UNKNOWN;alias SDL_SENSOR_ACCEL = SDL_SensorType.SDL_SENSOR_ACCEL;alias SDL_SENSOR_GYRO = SDL_SensorType.SDL_SENSOR_GYRO;

// expansion at ../../.dub/packages/bindbc-sdl/1.2.4/bindbc-sdl/source/bindbc/sdl/bind/sdlgamecontroller.d(31,5)
alias SDL_CONTROLLER_TYPE_UNKNOWN = SDL_GameControllerType.SDL_CONTROLLER_TYPE_UNKNOWN;alias SDL_CONTROLLER_TYPE_XBOX360 = SDL_GameControllerType.SDL_CONTROLLER_TYPE_XBOX360;alias SDL_CONTROLLER_TYPE_XBOXONE = SDL_GameControllerType.SDL_CONTROLLER_TYPE_XBOXONE;alias SDL_CONTROLLER_TYPE_PS3 = SDL_GameControllerType.SDL_CONTROLLER_TYPE_PS3;alias SDL_CONTROLLER_TYPE_PS4 = SDL_GameControllerType.SDL_CONTROLLER_TYPE_PS4;alias SDL_CONTROLLER_TYPE_NINTENDO_SWITCH_PRO = SDL_GameControllerType.SDL_CONTROLLER_TYPE_NINTENDO_SWITCH_PRO;alias SDL_CONTROLLER_TYPE_VIRTUAL = SDL_GameControllerType.SDL_CONTROLLER_TYPE_VIRTUAL;alias SDL_CONTROLLER_TYPE_PS5 = SDL_GameControllerType.SDL_CONTROLLER_TYPE_PS5;alias SDL_CONTROLLER_TYPE_AMAZON_LUNA = SDL_GameControllerType.SDL_CONTROLLER_TYPE_AMAZON_LUNA;alias SDL_CONTROLLER_TYPE_GOOGLE_STADIA = SDL_GameControllerType.SDL_CONTROLLER_TYPE_GOOGLE_STADIA;
...
// expansion at ../../.dub/packages/bindbc-sdl/1.2.4/bindbc-sdl/source/bindbc/sdl/bind/sdlmouse.d(53,5)
alias SDL_MOUSEWHEEL_NORMAL = SDL_MouseWheelDirection.SDL_MOUSEWHEEL_NORMAL;alias SDL_MOUSEWHEEL_FLIPPED = SDL_MouseWheelDirection.SDL_MOUSEWHEEL_FLIPPED;
...
// expansion at ../../.dub/packages/bindbc-sdl/1.2.4/bindbc-sdl/source/bindbc/sdl/bind/sdlrender.d(40,5)
alias SDL_ScaleModeNearest = SDL_ScaleMode.SDL_ScaleModeNearest;alias SDL_ScaleModeLinear = SDL_ScaleMode.SDL_ScaleModeLinear;alias SDL_ScaleModeBest = SDL_ScaleMode.SDL_ScaleModeBest;
