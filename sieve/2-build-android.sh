...
# CPU Mediatek MT6580 32-bit Arm Cortex-A7
...
##old: #curl -L -O https://raw.githubusercontent.com/dlang/dmd/master/samples/sieve.d
#curl -L -O https://raw.githubusercontent.com/dlang/dmd/master/compiler/samples/sieve.d
